...
export const mockConversions: MockConversion[] = [
  { id: 'c-1', plan: 'Family Plus', saleAmount: 89, commission: 17.80, status: 'APPROVED', date: '2026-09-14', partnerId: 'p-1', partnerName: 'Marcus Johnson', storefrontId: 's-1', storefrontName: 'Marcus Care Partners', attributionSource: 'Storefront Link', attributionState: 'ATTRIBUTED', clickId: 'clk-a1b2c3d4', customerName: 'Jennifer Smith', customerEmail: 'j.smith@email.com', attributedVia: 'STOREFRONT' },
  { id: 'c-2', plan: 'Care Circle', saleAmount: 149, commission: 29.80, status: 'APPROVED', date: '2026-09-13', partnerId: 'p-1', partnerName: 'Marcus Johnson', storefrontId: 's-1', storefrontName: 'Marcus Care Partners', attributionSource: 'Storefront Link', attributionState: 'ATTRIBUTED', clickId: 'clk-e5f6g7h8', customerName: 'Michael Park', customerEmail: 'm.park@email.com', attributedVia: 'STOREFRONT' },
  ...
  { id: 'c-13', plan: 'Care Circle', saleAmount: 149, commission: 29.80, status: 'PENDING', date: '2026-09-17', partnerId: 'p-1', partnerName: 'Marcus Johnson', storefrontId: 's-1', storefrontName: 'Marcus Care Partners', attributionSource: 'Lidia', attributionState: 'PENDING', clickId: 'clk-lidia-001', customerName: 'Olivia Bennett', customerEmail: 'o.bennett@email.com', campaignSource: 'Lidia', attributedVia: 'LIDIA' },
];
...
export const mockResources: MockResource[] = [
  { id: 'r-1', title: 'Careverse Brand Guidelines', type: 'BRAND_ASSET', category: 'CREATOR', description: 'Logos, colors, and typography for your storefront and promotions.', url: '', icon: 'palette', published: true, order: 1, createdAt: '2026-08-01', updatedAt: '2026-08-15', assetSource: 'EXTERNAL' },
  { id: 'r-2', title: 'Approved Social Media Copy', type: 'COPY', category: 'CREATOR', description: 'Pre-written posts for Instagram, TikTok, and Facebook.', url: '', icon: 'file-text', published: true, order: 2, createdAt: '2026-08-01', updatedAt: '2026-08-20', assetSource: 'EXTERNAL' },
  { id: 'r-3', title: 'Product Information Sheet', type: 'PRODUCT_INFO', category: 'CREATOR', description: 'Complete details on Family, Family Plus, and Care Circle plans.', url: '', icon: 'info', published: true, order: 3, createdAt: '2026-08-01', updatedAt: '2026-09-01', assetSource: 'EXTERNAL' },
  { id: 'r-4', title: 'Getting Started Guide', type: 'GUIDE', category: 'ALL', description: 'Everything you need to launch your storefront and make your first sale.', url: '', icon: 'book-open', published: true, order: 0, createdAt: '2026-07-15', updatedAt: '2026-09-10', assetSource: 'EXTERNAL' },
  { id: 'r-5', title: 'How to Promote Careverse', type: 'VIDEO', category: 'CREATOR', description: 'A 10-minute walkthrough of best practices for promoting your storefront.', url: '', icon: 'video', published: true, order: 4, createdAt: '2026-08-05', updatedAt: '2026-08-05', assetSource: 'EXTERNAL' },
  { id: 'r-6', title: 'Agency Brand Kit', type: 'BRAND_ASSET', category: 'BUSINESS', description: 'Extended brand assets for agencies managing multiple storefronts.', url: '', icon: 'palette', published: true, order: 1, createdAt: '2026-08-01', updatedAt: '2026-08-15', assetSource: 'EXTERNAL' },
  { id: 'r-7', title: 'Client Onboarding Templates', type: 'COPY', category: 'BUSINESS', description: 'Email and document templates for onboarding your clients to Careverse.', url: '', icon: 'file-text', published: true, order: 2, createdAt: '2026-08-01', updatedAt: '2026-08-20', assetSource: 'EXTERNAL' },
  { id: 'r-8', title: 'Full Product Catalog', type: 'PRODUCT_INFO', category: 'BUSINESS', description: 'Detailed catalog with pricing, features, and comparison sheets for all plans.', url: '', icon: 'info', published: true, order: 3, createdAt: '2026-08-01', updatedAt: '2026-09-01', assetSource: 'EXTERNAL' },
  { id: 'r-9', title: 'Agency Playbook', type: 'GUIDE', category: 'BUSINESS', description: 'How to build and manage a portfolio of Careverse storefronts for your clients.', url: '', icon: 'book-open', published: true, order: 4, createdAt: '2026-08-05', updatedAt: '2026-08-05', assetSource: 'EXTERNAL' },
  { id: 'r-10', title: 'Client Management Best Practices', type: 'VIDEO', category: 'BUSINESS', description: 'Strategies for managing multiple partner accounts and reporting to clients.', url: '', icon: 'video', published: true, order: 5, createdAt: '2026-08-05', updatedAt: '2026-08-05', assetSource: 'EXTERNAL' },
  { id: 'r-11', title: 'Content Angles & Post Ideas', type: 'COPY', category: 'CREATOR', description: 'Ready-to-use content angles, social post ideas, and video concepts for promoting Careverse.', url: '', icon: 'megaphone', published: true, order: 5, createdAt: '2026-09-01', updatedAt: '2026-09-12', assetSource: 'EXTERNAL' },
  { id: 'r-12', title: 'Campaign Materials Pack', type: 'DOWNLOAD', category: 'ALL', description: 'Downloadable pack with campaign graphics, email banners, and promo copy for seasonal campaigns.', url: '', icon: 'download', published: false, order: 6, createdAt: '2026-09-05', updatedAt: '2026-09-05', assetSource: 'EXTERNAL' },
];

...
import { Check, Heart, Shield, Sparkles, ArrowRight, X, Wallet } from 'lucide-react';
      ...
      <footer className="bg-cv-night py-12">
        <div className="max-w-6xl mx-auto px-5 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm cv-night-text">Lidia is free for everyone. Building the world&apos;s largest AI-powered care network.</p>
          </div>
